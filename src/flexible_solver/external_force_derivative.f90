...
wing%FJ_ext = 0.d0
  ...
  do j=1,np
      ...
      wing%FJ_ext(j+2*np,j+2*np) = wing%FJ_ext(j+2*np,j+2*np) - &
                                   wing%m(j)*(wing%vr(1)**2 + wing%vr(2)**2)
  enddo
