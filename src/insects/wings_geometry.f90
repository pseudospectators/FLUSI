...
end subroutine DrawWing_simple
...
! In the first call, the arrays Insect%ai and Insect%bi, that hold the Fourier
...
subroutine Setup_Wing_Fourier_coefficients(Insect)
  ...
  case ('drosophila')
    ...
    Insect%a0 = 0.5140278
    Insect%ai = (/0.1276258,-0.1189758,-0.0389458,0.0525938,0.0151538,-0.0247938,&
    ...
    Insect%bi = (/-0.1072518,-0.0449318,0.0296558,0.0265668,-0.0043988,-0.0113218,&
  ...
  case ('drosophila_mutated')
    ...
    allocate ( Insect%ai(1:Insect%n_fft), Insect%bi(1:Insect%n_fft) )
    Insect%a0 = 0.4812548
    Insect%ai = (/0.1593968, -0.1056828, -0.0551518, 0.0508748, 0.0244538, -0.0264738,&
    ...
    Insect%bi = (/-0.1132588, -0.0556428, 0.0272098, 0.0221478, -0.0063798, -0.0059078,&
  ...
  case ('drosophila_sandberg')
    ...
    allocate ( Insect%ai(1:Insect%n_fft), Insect%bi(1:Insect%n_fft) )
    Insect%a0 = 0.4995578 
    Insect%ai = (/0.0164168,-0.1621518,0.0030938,0.0601108,-0.0083988,-0.0199988,&
    ...
    /)
    Insect%bi = (/-0.2083518,-0.0106488,0.0878308,-0.0018168,-0.0338278,0.0045768,&
  ...
  case ('drosophila_maeda')
    ...
    !Insect%ai = (/0.11389995408864588, -0.08814321795213981, -0.03495210456149335,&
    ...
    !Insect%bi = (/0.0961275426181888, 0.049085916171592914, -0.022051083533094627,&
    ...
    Insect%ai = (/0.113400475583443, -0.0862823485047213, -0.0346234482214816,&
    ...
    Insect%bi = (/0.0939265226506824,0.0486063180327962,-0.0206591129298861,&
  ...
  case ('drosophila_sun')
    ...
    Insect%ai = (/0.10879717599747996, -0.11445383382313232, -0.02023898255134523,&
    ...
    Insect%bi = (/-0.09385487982296374, -0.010821846776797858, 0.030052970821579587,&
  ...
  case ('flapper_sane')
    ...
    Insect%ai = (/0.135338653455782,-0.06793162622123261,-0.0398235167675977,&
    ...
    Insect%bi = (/2.686408368800394E-4,0.01649582345310688,0.01288513083639708,&
