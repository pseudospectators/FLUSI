...
subroutine Setup_Wing_Fourier_coefficients(Insect,idw)
  ...
  case ('paratuposa_flatwing')
    ...
    Insect%a0_wings(idw) = 0.739896497062441d0
    Insect%ai_wings(1:Insect%nfft_wings(idw),idw) = &
    (/-0.176018890506486d0,0.00488217912355746d0,-0.0442789662809104d0,&
    0.0105293428235250d0,-0.0128717078451741d0,0.0108523672611459d0,&
    0.00391764735280552d0,-0.00342987502472359d0,-0.000460524976538830d0,&
    0.00240419573878945d0,-0.000536007356092983d0,-0.000582587358635112d0,&
    0.00286834558381896d0,-0.00239496179935696d0,-4.88808999730590d-6/)
    Insect%bi_wings(1:Insect%nfft_wings(idw),idw) = &
    (/0.138018294004402d0,0.0476879769884003d0,-0.0378223135799210d0,&
    0.00209244675553742d0,-0.00816393549592736d0,-0.0128636325385091d0,&
    0.00709478152752571d0,-0.00177400319447458d0,-0.000571551412955283d0,&
    -0.000927758440373684d0,0.00212691398565415d0,-0.00238298038449043d0,&
    0.00108162521400722d0,0.00173329460902148d0,-0.00222809891249035d0/)
    Insect%xc(idw) = -0.3d0
    Insect%yc(idw) = 0.7d0
  ...
  case ('paratuposa_flatelytra')
    ...
    Insect%a0_wings(idw) = 0.565146320110115d0
    Insect%ai_wings(1:Insect%nfft_wings(idw),idw) = &
    ...
    Insect%xc(idw) = -0.02d0
    Insect%yc(idw) = 0.65d0
