...
subroutine Setup_Wing_Fourier_coefficients(Insect)
  ...
  case ('b_ignitus')
    ...
    Insect%n_fft = 25
    allocate ( ai(1:Insect%n_fft), bi(1:Insect%n_fft) )
    Insect%a0 = 0.536472532931637d0
    ai = (/-0.0447167394708177d0,-0.106357727795917d0,0.0504418160417239d0,&
    ...
    bi = (/-0.0580660125663764d0,0.0271775529659247d0,0.0178916506228727d0,&
